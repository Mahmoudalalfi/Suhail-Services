    ...
    <div ref={rowRef} className={`timeline-zz-row timeline-zz-row--${isLeft ? 'left' : 'right'}`}>
      ...
      <div
        ...
        style={{
          ...
          borderLeft: hovered ? '3px solid #FACC15' : '3px solid rgba(30,31,40,0.06)',
        }}
      ...
      <div
        ...
        style={{ background: hovered ? '#FACC15' : '#0047CC', transition: 'background 0.25s ease' }}
      />
    </div>
  )
}
          ...
          <div style={{
            ...
            {stats.map((s, i) => (
              <RevealBlock key={i} delay={i * 0.06}>
                <div style={{ borderTop: '2px solid rgba(255,255,255,0.3)', paddingTop: 22 }}>
                  <p style={{
