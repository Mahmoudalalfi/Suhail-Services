...
export default function LiquidButton({
  ...
  const solidStyle = {
    ...
    boxShadow: hovered
      ...
      : '0 3px 14px rgba(0,0,0,0.18), inset 0 1px 0 rgba(255,255,255,0.14)',
  }
  ...
  const glassStyle = {
    ...
    boxShadow: hovered
      ? '0 8px 32px rgba(0,0,0,0.22), inset 0 1px 0 rgba(255,255,255,0.45), inset 0 -1px 0 rgba(0,0,0,0.06)'
      : '0 4px 16px rgba(0,0,0,0.14), inset 0 1px 0 rgba(255,255,255,0.35), inset 0 -1px 0 rgba(0,0,0,0.05)',
  }
  ...
  return (
    ...
    >
      ...
      <span aria-hidden style={{
        ...
        background: 'linear-gradient(to bottom, rgba(255,255,255,0.22) 0%, rgba(255,255,255,0.02) 100%)',
        pointerEvents: 'none',
      }} />
