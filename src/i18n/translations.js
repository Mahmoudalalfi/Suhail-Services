...
export default {
  de: {
    ...
    footer: {
      ...
      terms: 'AGB',
      brandTagline: 'Professionelle Lösungen in den Bereichen Gebäudereinigung, Facility Management und Personaldienstleistungen.',
    ...
    home: {
      ...
      mission: 'Reinigung · Lagerdienstleistungen · Kassiererservices · Transport · Elektroassistenz · Installation & Auspacken · Personaldienstleistungen · Allgemeine Dienstleistungen',
      aboutLink: 'Über uns',
