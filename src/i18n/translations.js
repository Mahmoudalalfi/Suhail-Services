  ...
  de: {
    ...
    home: {
      ...
      featured: [
        ...
        },
        {
          ...
          img: 'https://res.cloudinary.com/df7aiznm6/image/upload/v1782411379/warehouse-support_hevwdd.png',
        },
      ],
      testimonials: [
        {
    ...
    about: {
      ...
      pillars: [
        ...
        { id: 'logistics', icon: 'logistics', title: 'Lager & Logistik', desc: 'Warenverräumung, Lagerunterstützung und flexible Logistikleistungen.' },
        { id: 'construction', icon: 'construction', title: 'Baustellenservice', desc: 'Unterstützung auf Baustellen durch zuverlässigen Service und qualifiziertes Personal.' },
      ],
    ...
    gallery: {
      ...
      title2: 'Galerie',
      imageLabels: [
        'Reinigungsteam', 'Gebäudereinigung', 'Unser Team', 'Baustellen',
        'Hausmeisterdienste', 'Facility Management', 'Projekt: Einzelhandel', 'Unsere Mitarbeiter',
        'Gesundheitseinrichtungen', 'Außenflächenpflege', 'Tagesdienstpersonal', 'Unterhaltsreinigung',
        'Projekt: Bürokomplex', 'Projekt: Lager', 'Glasfassadenreinigung', 'Projekt: Berlin',
        'Sonderreinigung', 'Projekt: Einzelhandelskette',
      ],
    ...
    work: {
      ...
      title2: 'überzeugt',
      projects: [
        { title: 'Bürokomplex Berlin', tag: 'Büroreinigung', year: '2024', img: 'https://res.cloudinary.com/df7aiznm6/image/upload/v1777490371/suhail-services/home_featured_2_1777327634216.jpg' },
        { title: 'Lagerunterstützung', tag: 'Logistikservice', year: '2024', img: 'https://res.cloudinary.com/df7aiznm6/image/upload/v1782411379/warehouse-support_hevwdd.png' },
        { title: 'Baustelle Berlin', tag: 'Baustellenservice', year: '2024', img: 'https://res.cloudinary.com/df7aiznm6/image/upload/v1777490580/suhail-services/pencil-facility-construction-sites.png' },
        { title: 'Hotel & Lobby', tag: 'Bodenpflege', year: '2024', img: 'https://res.cloudinary.com/df7aiznm6/image/upload/v1777490816/suhail-services/work-project-06.png' },
        ...
        { title: 'Facility Management', tag: 'Technische Wartung', year: '2023', img: 'https://res.cloudinary.com/df7aiznm6/image/upload/v1777490810/suhail-services/work-project-04.png' },
  ...
  en: {
    ...
    about: {
      ...
      pillars: [
        ...
        { id: 'logistics', icon: 'logistics', title: 'Warehouse & Logistics', desc: 'Goods handling, warehouse support, and flexible logistics services.' },
        { id: 'construction', icon: 'construction', title: 'Construction Site Service', desc: 'On-site support through reliable service and qualified personnel.' },
      ],
    ...
    gallery: {
      ...
      title2: 'Gallery',
      imageLabels: [
        'Cleaning Team', 'Building Cleaning', 'Our Team', 'Construction Sites',
        'Janitorial Services', 'Facility Management', 'Project: Retail', 'Our People',
        'Healthcare Facilities', 'Outdoor Area Care', 'Day Service Staff', 'Maintenance Cleaning',
        'Project: Office Complex', 'Project: Warehouse', 'Glass Facade Cleaning', 'Project: Berlin Site',
        'Special Cleaning', 'Project: Retail Chain',
      ],
    ...
    work: {
      ...
      title2: 'Convinces',
      projects: [
        { title: 'Berlin Office Complex', tag: 'Office Cleaning', year: '2024', img: 'https://res.cloudinary.com/df7aiznm6/image/upload/v1777490371/suhail-services/home_featured_2_1777327634216.jpg' },
        { title: 'Warehouse Support', tag: 'Logistics Service', year: '2024', img: 'https://res.cloudinary.com/df7aiznm6/image/upload/v1782411379/warehouse-support_hevwdd.png' },
        { title: 'Construction Site Berlin', tag: 'Construction Service', year: '2024', img: 'https://res.cloudinary.com/df7aiznm6/image/upload/v1777490580/suhail-services/pencil-facility-construction-sites.png' },
        { title: 'Hotel & Lobby Area', tag: 'Floor Care', year: '2024', img: 'https://res.cloudinary.com/df7aiznm6/image/upload/v1777490816/suhail-services/work-project-06.png' },
        ...
        { title: 'Facility Management', tag: 'Technical Maintenance', year: '2023', img: 'https://res.cloudinary.com/df7aiznm6/image/upload/v1777490810/suhail-services/work-project-04.png' },
