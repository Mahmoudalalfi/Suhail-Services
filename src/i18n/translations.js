...
export default {
  de: {
    ...
    home: {
      ...
      homeServices: [
        { title: 'Gebäudereinigung', desc: 'Professionelle Reinigung für Gebäude aller Art.' },
        { title: 'Bau- & Grundreinigung', desc: 'Bauendreinigung & intensive Grundreinigung nach Bedarf.' },
        { title: 'Büro- & Unterhaltsreinigung', desc: 'Regelmäßige Reinigung für ein gepflegtes Arbeitsumfeld.' },
        { title: 'Transport & Logistik', desc: 'Lieferung, Logistikunterstützung & Umzugsservice.' },
        { title: 'Montage & Installation', desc: 'Möbelmontage, Installationsservice & Auspacken.' },
        { title: 'Lager & Kommissionierung', desc: 'Kommissionierung, Sortierung, Verpackung & Warenprüfung.' },
        { title: 'Elektrohilfsarbeiten', desc: 'Hilfsleistungen für Elektroarbeiten auf Baustellen.' },
        { title: 'Flexible Dienstleistungen', desc: 'Bedarfsgerechte Unterstützung für Unternehmen & Privatkunden.' },
      ],
    },
    services: {
      ...
      servicesList: [
        {
          ...
          desc: 'Flexible Unterstützung für Unternehmen und Privatkunden – auf Abruf verfügbar.',
          items: [
            { slug: 'general-services', name: 'Allgemeine Dienstleistungen', subtitle: 'Für Unternehmen und Privatkunden', desc: 'Flexible Unterstützung auf Abruf für Unternehmen und Privatkunden – zuverlässig und unkompliziert.' },
          ],
        },
        {
          category: 'Reinigung',
        ...
        {
          category: 'Kassendienste',
          desc: 'Zuverlässiges Kassenpersonal für Supermärkte und Einzelhandel.',
          items: [
            { slug: 'cashier-services', name: 'Kassendienste', subtitle: 'Kassenpersonal für Handel & Märkte', desc: 'Qualifizierte Kassierer für Supermärkte und Einzelhandel – zuverlässig und flexibel einsetzbar.' },
          ],
        },
        {
          category: 'Lagerdienstleistungen',
          desc: 'Professionelle Lagerarbeit – von der Kommissionierung bis zur Warenkontrolle.',
          items: [
            { slug: 'warehouse-services', name: 'Lagerdienstleistungen', subtitle: 'Kommissionierung, Verpackung & mehr', desc: 'Kommissionierung, Verpackung, Sortierung und Warenkontrolle – zuverlässig und effizient.' },
          ],
        },
        {
          category: 'Montage & Auspacken',
          desc: 'Möbelmontage, Installationsservice und Auspackservice.',
          items: [
            { slug: 'installation-unpacking', name: 'Montage & Auspacken', subtitle: 'Möbelmontage & Installationsservice', desc: 'Professionelle Möbelmontage, Installationsservice und Auspackservice – schnell und sorgfältig.' },
          ],
        },
        {
          category: 'Elektrohilfsarbeiten',
          desc: 'Unterstützung bei Elektroarbeiten und Baustellenhilfe.',
          items: [
            { slug: 'electrical-assistance', name: 'Elektrohilfsarbeiten', subtitle: 'Hilfsarbeiten auf Baustellen', desc: 'Unterstützung bei Elektroarbeiten und Hilfsleistungen auf Baustellen – flexibel und kurzfristig verfügbar.' },
          ],
        },
        {
          category: 'Transport',
          desc: 'Umzüge, Lieferungen und Logistikunterstützung.',
          items: [
            { slug: 'transport', name: 'Transport', subtitle: 'Umzug, Lieferung & Logistik', desc: 'Umzugsservice, Lieferungen und Logistikunterstützung – pünktlich, sicher und zuverlässig.' },
          ],
        },
        {
          category: 'Personaldienstleistungen',
          desc: 'Zeitarbeitskräfte und flexible Personalvermittlung für Projekte.',
          items: [
            { slug: 'staffing-services', name: 'Personaldienstleistungen', subtitle: 'Zeitarbeit & flexible Arbeitskräfte', desc: 'Qualifizierte Zeitarbeitskräfte und flexible Personalvermittlung – kurzfristig verfügbar für Ihre Projekte.' },
          ],
        },
      ],
      process: [
    ...
    gallery: {
      ...
      servicesData: [
        { category: 'Allgemeine Dienstleistungen', desc: 'Flexible Unterstützung für Unternehmen und Privatpersonen – auf Abruf.', bullets: ['Dienstleistungen für Unternehmen und Privatpersonen', 'Flexible Unterstützung', 'Auf Abruf'] },
        { category: 'Reinigung', desc: 'Professionelle Reinigung für jeden Bereich – zuverlässig, effizient, maßgeschneidert.', bullets: ['Büroreinigung', 'Baureinigung', 'Grundreinigung', 'Unterhaltsreinigung'] },
        { category: 'Kassendienste', desc: 'Zuverlässiges Kassenpersonal für Supermärkte und Einzelhandel.', bullets: ['Kassierer für Supermärkte', 'Kassenunterstützung', 'Einzelhandelspersonal'] },
        { category: 'Lagerdienste', desc: 'Professionelle Lagerarbeit – von der Kommissionierung bis zur Warenprüfung.', bullets: ['Kommissionierung', 'Sortierung', 'Verpackung', 'Warenprüfung'] },
        { category: 'Montage & Auspacken', desc: 'Möbelmontage, Installationsservice und Auspacken.', bullets: ['Möbelmontage', 'Installationsservice', 'LR-Packservice'] },
        { category: 'Elektroassistenz', desc: 'Unterstützung bei Elektroarbeiten auf Baustellen.', bullets: ['Hilfsdienste für Elektriker', 'Hilfsdienste vor Ort'] },
        { category: 'Transport', desc: 'Umzugsservice, Lieferungen und Logistikunterstützung.', bullets: ['Umzugswagen / Autos', 'Lieferung', 'Logistikunterstützung'] },
        { category: 'Personaldienstleistungen', desc: 'Qualifizierte Zeitarbeiter und flexible Personallösungen.', bullets: ['Zeitarbeiter', 'Flexible Belegschaft für Projekte'] },
      ],
      ...
      whyItems: [
        ...
        { title: 'Schnelle Reaktion', desc: 'Wir mobilisieren schnell. Kurzfristige Anfragen, Notfälle, Last-Minute-Personal – wir sind bereit, wenn Sie uns brauchen.' },
        ...
        { title: 'Expertteam', desc: 'Geschulte, geprüfte Fachkräfte aus allen Bereichen – von Reinigungsteams bis zu Lagerspezialisten.' },
        { title: 'Alles aus einer Hand', desc: 'Von Personaldienstleistungen bis Bausupport – alle Leistungen unter einem Dach, ein Ansprechpartner, kein Aufwand.' },
        { title: 'Deutschlandweite Abdeckung', desc: 'In allen großen Städten und Regionen aktiv – wir kommen zu Ihrem Standort, wo immer Sie sind.' },
        { title: 'Qualität garantiert', desc: 'Jeder Auftrag wird nach höchstem Standard erledigt. Wir übernehmen Verantwortung, damit Sie keine Ergebnisse einfordern müssen.' },
        { title: 'Kunde an erster Stelle', desc: 'Langfristige Beziehungen auf Basis von Vertrauen, offener Kommunikation und echtem Interesse an Ihrem Geschäftserfolg.' },
      ],
    },
    work: {
  ...
  en: {
    ...
    home: {
      ...
      homeServices: [
        { title: 'Building Cleaning', desc: 'Professional cleaning for all types of buildings.' },
        { title: 'Construction & Deep Cleaning', desc: 'Post-construction & intensive deep cleaning on demand.' },
        { title: 'Office & Maintenance Cleaning', desc: 'Regular cleaning for a well-maintained work environment.' },
        { title: 'Transport & Logistics', desc: 'Delivery, logistics support & relocation service.' },
        { title: 'Assembly & Installation', desc: 'Furniture assembly, installation service & unpacking.' },
        { title: 'Warehousing & Order Picking', desc: 'Picking, sorting, packing & goods inspection.' },
        { title: 'Electrical Support Work', desc: 'Helper services for electrical work on construction sites.' },
        { title: 'Flexible Services', desc: 'On-demand support for companies & private clients.' },
      ],
    },
    services: {
      ...
      servicesList: [
        {
          ...
          items: [
            { slug: 'general-services', name: 'General Services', subtitle: 'For companies and private clients', desc: 'Flexible support on demand for companies and private clients – reliable and straightforward.' },
          ],
        },
        {
          category: 'Cleaning',
        ...
        },
        {
          ...
          items: [
            { slug: 'cashier-services', name: 'Cashier Services', subtitle: 'Checkout staff for retail & supermarkets', desc: 'Qualified cashiers for supermarkets and retail – reliable and flexibly deployable.' },
          ],
        },
        {
          ...
          items: [
            { slug: 'warehouse-services', name: 'Warehouse Services', subtitle: 'Picking, packing & more', desc: 'Order picking, packing, sorting, and goods inspection – reliable and efficient.' },
          ],
        },
        {
          ...
          items: [
            { slug: 'installation-unpacking', name: 'Installation & Unpacking', subtitle: 'Furniture assembly & installation', desc: 'Professional furniture assembly, installation services, and unpacking – fast and careful.' },
          ],
        },
        {
          ...
          items: [
            { slug: 'electrical-assistance', name: 'Electrical Assistance', subtitle: 'Helper services on construction sites', desc: 'Support for electrical work and helper services on construction sites – flexible and available on short notice.' },
          ],
        },
        {
          category: 'Transport',
          ...
          items: [
            { slug: 'transport', name: 'Transport', subtitle: 'Moving, delivery & logistics', desc: 'Moving services, deliveries, and logistics support – punctual, safe, and reliable.' },
          ],
        },
        {
          category: 'Staffing Services',
          desc: 'Temporary workers and flexible workforce for projects.',
          items: [
    ...
    gallery: {
      ...
      servicesData: [
        { category: 'General Services', desc: 'Flexible support for companies and private clients – available on demand.', bullets: ['Services for companies and private clients', 'Flexible support', 'On demand'] },
        { category: 'Cleaning', desc: 'Professional cleaning for every area – reliable, efficient, tailored.', bullets: ['Office cleaning', 'Construction cleaning', 'Deep cleaning', 'Maintenance cleaning'] },
        { category: 'Cashier Services', desc: 'Reliable checkout staff for supermarkets and retail.', bullets: ['Cashiers for supermarkets', 'Checkout staff support', 'Retail staff support'] },
        { category: 'Warehouse Services', desc: 'Professional warehouse work – from order picking to goods inspection.', bullets: ['Picking', 'Sorting', 'Packing', 'Goods inspection'] },
        { category: 'Installation & Unpacking', desc: 'Furniture assembly, installation services, and unpacking.', bullets: ['Furniture assembly', 'Installation services', 'LR packing service'] },
        { category: 'Electrical Assistance', desc: 'Support for electrical work and helper services on construction sites.', bullets: ['Helper services for electrical work', 'Helper services on site'] },
        { category: 'Transport', desc: 'Moving services, deliveries, and logistics support.', bullets: ['Moving vans / cars', 'Delivery', 'Logistics support'] },
        { category: 'Staffing Services', desc: 'Qualified temporary workers and flexible staffing for projects.', bullets: ['Temporary workers', 'Flexible workforce for projects'] },
      ],
      ...
      whyItems: [
        ...
        { title: 'Fast Response', desc: 'We mobilise quickly. Short notice, urgent requests, last-minute staffing — we are ready when you need us.' },
        { title: 'Transparent Pricing', desc: 'No hidden fees, no surprises. Clear, fair pricing tailored to the scope of your project.' },
        { title: 'Expert Team', desc: 'Trained, vetted professionals across all disciplines — from cleaning crews to warehouse specialists.' },
        { title: 'One-Stop Solution', desc: 'From staffing to construction support — all services under one roof, one contact, zero hassle.' },
        { title: 'Germany-Wide Coverage', desc: 'Operating across all major cities and regions — we come to your location, wherever you are.' },
        { title: 'Quality Guaranteed', desc: 'Every job is completed to the highest standard. We hold ourselves accountable so you never have to chase results.' },
        { title: 'Client-First Mindset', desc: 'Long-term relationships built on trust, open communication, and genuine care for your business.' },
      ],
    },
    work: {
