...
export default {
  de: {
    ...
    footer: {
      ...
      terms: 'AGB',
      brandTagline: 'Professionelle Lösungen in den Bereichen Sicherheitsdienstleistungen, Bau- und Reinigungsservices.',
    ...
    home: {
      ...
      heroSub: 'Professionelle Lösungen aus einer Hand',
      workTitle1: 'Leistungen, die',
      workTitle2: 'Überzeugen',
      workLink: 'Alle Projekte ansehen',
      missionEyebrow: 'Aus einer Hand',
      mission: 'Reinigung · Lagerdienstleistungen · Kassiererservices · Transport · Elektroassistenz · Installation & Auspacken · Bau & Innenausbau · Personaldienstleistungen · Allgemeine Dienstleistungen',
      aboutLink: 'Über uns',
      testimonialsTitle1: 'Zuverlässigkeit, die',
      testimonialsTitle2: 'man spürt.',
      cta1: 'IHR PARTNER',
      cta2: 'F\u00DCR',
      cta3: 'SERVICE',
      ticker: [
      ...
      featured: [
        {
          title: 'Kaufhaus Sicherheit',
          tag: 'Objektschutz & Detektei',
          img: 'https://res.cloudinary.com/dfc0qnh88/image/upload/v1777490800/suhail-services/work-project-01.png',
        },
        {
      ...
      homeServices: [
        { title: 'Reinigung', desc: 'Büro-, Bau-, Grund- & Unterhaltsreinigung.' },
        { title: 'Lagerdienstleistungen', desc: 'Kommissionierung, Sortierung, Verpackung & Warenprüfung.' },
        { title: 'Kassendienste', desc: 'Qualifiziertes Kassenpersonal für Einzelhandel & Supermärkte.' },
        { title: 'Transport', desc: 'Umzugswagen, Lieferung & Logistikunterstützung.' },
        { title: 'Elektroassistenz', desc: 'Hilfsdienste für Elektroarbeiten auf Baustellen.' },
        { title: 'Montage & Auspacken', desc: 'Möbelmontage, Installationsservice & Auspacken.' },
        { title: 'Bau & Innenausbau', desc: 'Bauhilfsarbeiten, Renovierung & Trockenbau.' },
        { title: 'Personaldienstleistungen', desc: 'Zeitarbeiter & flexible Personallösungen.' },
        { title: 'Allgemeine Dienstleistungen', desc: 'Flexible Unterstützung für Unternehmen & Privatpersonen.' },
      ],
    },
    services: {
      ...
      servicesList: [
        ...
        {
          category: 'Bau & Innenausbau',
          desc: 'Handwerkliche Unterstützung für Bauprojekte und Innenausbau.',
          items: [
            { slug: 'construction-interior', name: 'Bau & Innenausbau', subtitle: 'Bauhelfer, Ausbau & Renovierung', desc: 'Baustellenhilfe, Innenausbau, Renovierung und Trockenbauarbeiten – professionell und termingerecht.' },
          ],
        },
        {
    ...
    about: {
      ...
      img1: 'https://res.cloudinary.com/dfc0qnh88/image/upload/v1777490337/suhail-services/about_1_1777327649561.jpg',
    ...
    contact: {
      ...
      companyNameLines: ['Adler Services & Security GmbH', 'Forstweg 99', '13465 Berlin'],
      socialLinks: [
        { label: 'Facebook', href: '#' },
        { label: 'TikTok', href: '#' },
    ...
    gallery: {
      ...
      title2: 'Galerie',
      imageLabels: [
        'Sicherheitsteam', 'Objektsicherheit', 'Unser Team', 'Baustellen',
        'Hausmeisterdienste', 'Sicherheitstechnik', 'Projekt: Einzelhandel', 'Unsere Mitarbeiter',
        ...
        'Sonderoperationen', 'Projekt: Einzelhandelskette',
      ],
      ...
      servicesData: [
        ...
        { category: 'Bau & Innenausbau', desc: 'Qualifizierte Unterstützung für Bauprojekte und Innenausbau.', bullets: ['Bauhilfsarbeiten', 'Innenausbau', 'Renovierung', 'Trockenbau'] },
    ...
    imprint: {
      ...
      addressLines: ['Forstweg 99', '13465 Berlin', 'Deutschland'],
  ...
  en: {
    ...
    footer: {
      ...
      terms: 'Terms',
      brandTagline: 'Professional solutions in security services, construction, and cleaning.',
    ...
    home: {
      ...
      heroSub: 'Professional solutions from a single source',
      workTitle1: 'Services that',
      workTitle2: 'Convince',
      workLink: 'View all projects',
      missionEyebrow: 'From one source',
      mission: 'Cleaning · Warehouse Services · Cashier Services · Transport · Electrical Assistance · Installation & Unpacking · Construction & Interior Work · Staffing Services · General Services',
      aboutLink: 'About us',
      testimonialsTitle1: 'Reliability you',
      testimonialsTitle2: 'can feel.',
      cta1: 'YOUR PARTNER',
      cta2: 'FOR',
      cta3: 'SERVICES',
      ticker: [
        ...
        'Construction & Interior Work & Renovation',
      ...
      featured: [
        {
          title: 'Department Store Security',
      ...
      homeServices: [
        ...
        { title: 'Warehouse Services', desc: 'Picking, sorting, packing & goods inspection.' },
        { title: 'Cashier Services', desc: 'Qualified checkout staff for retail & supermarkets.' },
        { title: 'Transport', desc: 'Moving vans, delivery & logistics support.' },
        { title: 'Electrical Assistance', desc: 'Helper services for electrical work on site.' },
        { title: 'Installation & Unpacking', desc: 'Furniture assembly, installation & packing.' },
        { title: 'Construction & Interior', desc: 'Construction assistance, renovation & drywall.' },
        { title: 'Staffing Services', desc: 'Temporary workers & flexible workforce solutions.' },
        { title: 'General Services', desc: 'Flexible on-demand support for companies & private clients.' },
      ],
    },
    services: {
      ...
      servicesList: [
        ...
        },
        {
          ...
          items: [
            { slug: 'construction-interior', name: 'Construction & Interior Work', subtitle: 'Assistance, finishing & renovation', desc: 'Construction assistance, interior finishing, renovation, and drywall work – professional and on schedule.' },
          ],
        },
        {
    ...
    gallery: {
      ...
      title2: 'Gallery',
      imageLabels: [
        'Security Team', 'Facility Security', 'Our Team', 'Construction Sites',
        'Janitorial Services', 'Security Technology', 'Project: Retail Security', 'Our People',
        ...
        'Special Operations', 'Project: Retail Chain',
      ],
      ...
      servicesData: [
        ...
        { category: 'Construction & Interior Work', desc: 'Skilled support for construction projects and interior finishing.', bullets: ['Construction assistance', 'Interior finishing', 'Renovation', 'Drywall work'] },
    ...
    imprint: {
      title: 'imprint',
      companyName: 'Adler Services & Security GmbH',
      addressLines: ['Forstweg 99', '13465 Berlin', 'Germany'],
